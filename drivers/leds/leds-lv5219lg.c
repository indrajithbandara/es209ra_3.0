...
static long lv5219lg_ls_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	long err = 0;
...
static const struct file_operations lv5219lg_ls_fops = {
		.owner = THIS_MODULE,
...
static long lv5219lg_panic_blink(int state)
{
